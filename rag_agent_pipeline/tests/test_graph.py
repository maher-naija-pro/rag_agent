...
class TestRouter:
    ...
    def test_subsequent_turn_routes_to_rewrite_query(self, base_state):
...
class TestBuildGraph:
    ...
    def test_has_all_nodes(self):
        ...
        expected = {"load_pdf", "chunk", "extract_metadata", "embed_and_store", "rewrite_query", "expand_query", "hyde", "self_query", "retrieve", "rerank", "generate"}
